...
const navigation = [
  ...
  { name: 'Internal Jobs', href: '/internal-recruitment/jobs', icon: TrendingUp },
  { name: 'My Applications', href: '/internal-recruitment/my-applications', icon: FileText },
  { name: 'Succession Planning', href: '/internal-recruitment/succession', icon: Target },
  ...
  { name: 'CMS', href: '/contracts', icon: FileText },
